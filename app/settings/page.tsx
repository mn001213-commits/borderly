...
import { ArrowLeft, Save, CheckCircle, LogOut, KeyRound, Camera, User, ShieldBan } from "lucide-react";
...
export default function SettingsPage() {
  ...
  const deleteAccount = async () => {
    ...
    try {
      ...
      // Delete user's data (posts, comments, etc. will cascade via FK)
  ...
  return (
    <div className="mx-auto w-full max-w-2xl px-4 pb-24 pt-4">
      ...
      {/* Danger Zone */}
      <div className="b-card b-animate-in p-5" style={{ animationDelay: "0.15s", border: "1px solid #FECACA" }}>
