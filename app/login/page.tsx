    ...
    if (error) {
      ...
      if (newAttempts >= MAX_LOGIN_ATTEMPTS) {
        ...
        if (error.message === "Invalid login credentials") {
          ...
          setMsg(t("login.emailNotConfirmed") || "Please verify your email before logging in.");
        } else {
  ...
  return (
    <div className="b-card b-animate-in p-6">
      ...
      <form onSubmit={submit} className="space-y-4">
        ...
        {successMsg && (
          <div className="rounded-xl px-4 py-3 text-sm" style={{ background: "#F0FDF4", border: "1px solid #BBF7D0", color: "#166534" }}>
            {successMsg}
          </div>
        )}
